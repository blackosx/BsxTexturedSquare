...
<img src="https://github.com/blackosx/BsxTexturedSquare/blob/main/preview_ui.jpg" alt="theme_preview" border="0">

<img src="https://github.com/blackosx/BsxTexturedSquare/blob/main/preview_password.jpg" alt="theme_preview" border="0">
...
**Using this theme**<br>
This repository contains a Blackosx directory with a sub-directory BsxTexturedSquare which contains all necessary ICNS files for the theme.
...
- then just add the BsxTexturedSquare directory

Either way, for this theme you will want to end up having
EFI/OC/Resources/Image/Blackosx/BsxTexturedSquare

You can switch the icon set used by OpenCanopy by changing the 'PickerVariant' key in OpenCore's config.plist to match the vendor and theme name of the icon set you want to display. So to instruct OpenCanopy to use this icon set you want to set the PickerVariant key to Blackosx\BsxTexturedSquare

```
                <key>PickerVariant</key>
                <string>Blackosx\BsxTexturedSquare</string>
```
